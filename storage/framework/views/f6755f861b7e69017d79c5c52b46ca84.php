<div class="d-flex">
    ...
    <div>
        <form action="<?php echo e(route('employees.destroy', ['employee' => $employee->id])); ?>" method="POST">
            ...
            data-name="<?php echo e($employee->firstname.' '.$employee->lastname); ?>"><i class="bi-trash"></i></button>
        </form>
    </div>
</div>
<?php /**PATH C:\Users\User\Downloads\modul10-master\resources\views/employee/action.blade.php ENDPATH**/ ?>